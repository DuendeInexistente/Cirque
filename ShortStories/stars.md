...
Cyan_Unit surfed the steam wave of it's own maddened attempt to live as several flight systems blew their fuses and died one by one, each reducing it's chances to continue existing a little further, a V forming on the water with it's advance, electricity trailing it's damaged wiring and circuitry. There was something in the way that Cyan_Unit did not have the time to analyse and was mostly obliterated into a fine mist, and then several seconds later it hit something hard, embedding itself in it.
