...
silent only
cd /mnt/sda2/Gits/cirque
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ShortStories/TwilightInThePast.md
badd +1 ShortStories/TwilightInThePastNotes.md
argglobal
silent! argdel *
$argadd ShortStories/TwilightInThePast.md
$argadd ShortStories/TwilightInThePastNotes.md
set lines=28 columns=77
winpos -6 20
edit ShortStories/TwilightInThePast.md
...
exe 'vert 1resize ' . ((&columns * 52 + 38) / 77)
exe 'vert 2resize ' . ((&columns * 24 + 38) / 77)
argglobal
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let s:l = 252 - ((12 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
edit ShortStories/TwilightInThePastNotes.md
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
